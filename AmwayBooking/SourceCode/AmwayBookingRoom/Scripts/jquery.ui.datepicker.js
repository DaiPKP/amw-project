...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		...
		dayNames: ['CN', 'T.2', 'T.3', 'T.4', 'T.5', 'T.6', 'T.7'], // For formatting
		dayNamesShort: ['CN', 'T.2', 'T.3', 'T.4', 'T.5', 'T.6', 'T.7'], // For formatting
		dayNamesMin: ['CN', 'T.2', 'T.3', 'T.4', 'T.5', 'T.6', 'T.7'], // Column headings for days starting at Sunday
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		buttonText: 'Lịch', // Text for trigger button
		buttonImage: 'Lịch', // URL for trigger button image
