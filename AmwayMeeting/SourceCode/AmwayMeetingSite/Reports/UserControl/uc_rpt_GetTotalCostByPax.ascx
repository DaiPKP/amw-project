<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_rpt_GetTotalCostByPax.ascx.cs" Inherits="Reports_UserControl_uc_rpt_GetTotalCostByPax" %>
<div style="height: auto">
    <div style="text-align:left; font-size:14px; font-weight:bold; color: #008080; margin-left:20px;">
        BÁO CÁO SỐ CHI PHÍ THỰC TẾ ĐÃ HỖ TRỢ THEO PAX
    </div>
