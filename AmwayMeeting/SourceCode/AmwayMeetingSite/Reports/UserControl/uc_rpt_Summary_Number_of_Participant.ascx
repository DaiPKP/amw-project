<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_rpt_Summary_Number_of_Participant.ascx.cs" Inherits="Reports_UserControl_uc_rpt_Summary_Number_of_Participant" %>
<div style="height: auto">
    <div style="text-align: left; font-size: 14px; font-weight: bold; color: #008080; margin-left: 20px;">
        BÁO CÁO TỔNG HỢP SỐ LƯỢNG SESSION VÀ SỐ LƯỢNG NGƯỜI THAM DỰ ƯỚC LƯỢNG
    </div>
    <script>
