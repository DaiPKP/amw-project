...
public partial class Meeting_UserControl_uc_NotSupportCostForeignerClone : System.Web.UI.UserControl
{
    public int _ID = -1;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        {
            lblAlerting.Text = "Bạn chưa nhập địa chỉ nhận thư ủy quyền!";
            return;
        }
