...
public partial class Meeting_UserControl_uc_NotSupportCostView : System.Web.UI.UserControl
{
    ...
    private void GetStatusMeetingRegisterCBO()
    {
        try
        {
            ...
            List<DAL.PRC_SYS_AMW_STATUS_MEETING_REGISTER_APPROVAL_CBOResult> lst = new List<DAL.PRC_SYS_AMW_STATUS_MEETING_REGISTER_APPROVAL_CBOResult>();
            lst = objBO.StatusMeetingRegisterGet_ApprovalCBO(1).ToList();
            if (lst != null)
            {
