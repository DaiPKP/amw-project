<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_rpt_GetSessionByPax.ascx.cs" Inherits="Reports_UserControl_uc_rpt_GetSessionByPax" %>
<div style="height: auto">
    <div style="text-align: left; font-size: 14px; font-weight: bold; color: #008080; margin-left: 20px;">
        BÁO CÁO TỔNG HỢP SỐ LƯỢNG ĐĂNG KÝ HỘI HỌP THEO TỈNH VÀ QUẬN
    </div>
    <script>
