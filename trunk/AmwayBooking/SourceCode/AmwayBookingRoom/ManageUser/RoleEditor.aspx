<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAdmin.master" AutoEventWireup="true" CodeFile="RoleEditor.aspx.cs" Inherits="ManageUser_RoleEditor" %>
...
<asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
    ...
    <div id="AddButPopUp" runat="server" style="width:284px; height:127px; text-align:center; background-color:White; border: 2px solid black; display:none;">
        ...
        <span>
            <asp:Label ID="Label1" runat="server" Text="Role Name:" />
