...
public partial class Manager_UserControl_uc_SearchBooking : System.Web.UI.UserControl
{
    ...
    protected void btSave_Click(object sender, EventArgs e)
    {
        ...
        RegistryRoomBO BO = new RegistryRoomBO();
        lblAlerting.Text = BO.UpdateBookingStatus(int.Parse(hdfId.Value), strBookingStatus, strPaymentStatus);
        LoadBookingGrid("", "","","Y", "Y");
    }
