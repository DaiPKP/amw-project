<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_rpt_Summary_Session_Expense.ascx.cs" Inherits="Reports_UserControl_uc_rpt_Summary_Session_Expense" %>
<div style="height: auto">
    <div style="text-align: left; font-size: 14px; font-weight: bold; color: #008080; margin-left: 20px;">
        BÁO CÁO TỔNG HỢP SESSION & EXPENSE BY MONTHLY
    </div>
    <script>
