<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_rpt_GetSessionByPaxADA.ascx.cs" Inherits="Reports_UserControl_uc_rpt_GetSessionByPaxADA" %>
<div style="height: auto">
    <div style="text-align: left; font-size: 14px; font-weight: bold; color: #008080; margin-left: 20px;">
        BÁO CÁO TỔNG HỢP & LIỆT KÊ CÁC LOẠI ĐĂNG KÝ HỘI HỌP CỦA MỘT NHÀ PHÂN PHỐI
    </div>
    <script>
        ...
        <div style="text-align: center; width: 100%">
            <table>
                <tr>
                    ...
                    <td style="text-align: right; padding-right: 5px; color: #008080; font-weight: bold;">ADA
                    </td>
                    <td style="text-align: left; padding-left: 5px;">
                        <asp:TextBox ID="txtADA" CssClass="txtBoxDate" runat="server" Width="150px"></asp:TextBox>
                    </td>
                    <td style="text-align: left; padding-left: 5px;">
