<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_Province.ascx.cs"
    Inherits="Category_UserControl_uc_Province" %>
        ...
        <ContentTemplate>
                        ...
                        <table width="100%">
                            <tr>
                                ...
                                <td align="left" class="tdsearch2">
                                    Tên tỉnh thành <span style="color: Red">(*)</span>:
                                </td>
                                <td align="left" class="tdsearch3">
                                    <asp:TextBox runat="server" ID="txtProvinceName" MaxLength="50" CssClass="txtBox" Width="100%"></asp:TextBox>
                                </td>
                                <td class="tdsearch4">
                                </td>
            ...
            <div id="divUserList">
                <asp:GridView ID="grdList" runat="server" AutoGenerateColumns="false" DataKeyNames="ID"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Tên tỉnh thành">
                            <ItemTemplate>
