                        ...
                        <table width="100%">
                            <tr>
                                ...
                                <td align="left" class="tdsearch3">
                                    <asp:TextBox runat="server" ID="txtTenDepartment" MaxLength="50" CssClass="txtBox" Width="100%"></asp:TextBox>
                                </td>
                                <td class="tdsearch4">
                                </td>
                                ...
                                <td align="left" class="tdsearch6">
                                    <asp:TextBox runat="server" ID="txtGhiChu" MaxLength="50" CssClass="txtBox" Width="100%"
                ...
                <asp:GridView ID="grdDepartmentList" runat="server" AutoGenerateColumns="false" DataKeyNames="ID"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Tên nhóm">
                            <ItemTemplate>
                                <asp:Label ID="lblListingTenDepartment" runat="server" Text='<%# Eval("DEPARTMENTNAME") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Ghi chú">
                            <ItemTemplate>
                                <asp:Label ID="lblListingGhiChu" runat="server" Text='<%# Eval("DESCRIPTION") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
