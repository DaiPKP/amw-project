...
public partial class Meeting_SupportCostForeignerClone : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if ((Session["UserID"] == null) || (!CheckPermission("27")))
        {
        ...
        else
        {
            ...
            else
            {
                ...
                uc_SupportCostForeignerClone1._ID = id;
            }
        }
